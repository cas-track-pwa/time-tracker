...
-- Apply to remote: npx wrangler d1 execute time-tracker --remote --file migrations/004_add_invoice_number.sql
-- Apply locally:   npx wrangler d1 execute time-tracker --local --file migrations/004_add_invoice_number.sql
